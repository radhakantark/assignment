...
public class MonToFriInstructionsSettler implements InstructionsSettler {		
	
	private boolean shouldSettle(LocalDate settleDate) {		
		if(settleDate.getDayOfWeek() != DayOfWeek.SATURDAY &&
				settleDate.getDayOfWeek() != DayOfWeek.SUNDAY) {
			return true;
		}
		return false;
	}
